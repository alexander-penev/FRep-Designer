...
- The columns are identical in size and differ only in twist: tx/k/phase = -3.75/+1.00/81deg, -1.25/+0.55/79deg, +1.25/+1.25/50deg, +3.75/-1.00/31deg. The fitted tx were -3.82/-1.25/+1.26/+3.80 and are snapped to a uniform 2.5 spacing (the front row's spacing, offset by 1.25) — each moves by under 0.08 world units, inside the fit's residual. Columns 1 and 4 are the same rate in opposite directions, 2 is the slow one, 3 the fastest. The RotateY sits *under* the TwistY so the total rotation at height y is k*y + a — a pure phase offset that leaves the rate alone.
